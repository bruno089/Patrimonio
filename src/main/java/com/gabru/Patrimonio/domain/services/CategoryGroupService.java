...
public class CategoryGroupService {
    ...
    public CategoryGroupDto create ( CategoryGroupDto categoryGroupDto ){
        ...
        if ( categoryGroupRepository.findByNameAndUser(categoryGroupDto.getName(),userDetailsServiceImpl.getUsuarioAutenticado()).isPresent()){
    ...
    public CategoryGroupDto read ( int id){
        Optional<CategoryGroup> categoryGroup = categoryGroupRepository.findByIdAndUser(id,userDetailsServiceImpl.getUsuarioAutenticado());
    ...
    public void delete ( int id){
        if ( categoryGroupRepository.findByIdAndUser(id, userDetailsServiceImpl.getUsuarioAutenticado()).isPresent()){
    ...
    public Stream<CategoryGroupDto> readAll () {
        return categoryGroupRepository.findAllByUser(userDetailsServiceImpl.getUsuarioAutenticado())
                .stream()
